...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.POST("/usage-account-recent-requests", s.mgmt.GetUsageAccountRecentRequests)
		...
		mgmt.GET("/qoder-config", s.mgmt.GetQoderConfig)
		mgmt.PUT("/qoder-config", s.mgmt.PutQoderConfig)
		mgmt.PATCH("/qoder-config", s.mgmt.PutQoderConfig)
		...
		mgmt.GET("/model-sources", s.mgmt.GetModelSources)
		mgmt.GET("/model-definitions/:channel", s.mgmt.GetStaticModelDefinitions)
		mgmt.GET("/model-context-status", s.mgmt.GetModelContextStatus)
		mgmt.GET("/model-context-overrides", s.mgmt.GetModelContextOverrides)
